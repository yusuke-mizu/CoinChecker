...
export function riskClass(level: string): string {
  if (level === "HIGH") return "text-rose-200 border-rose-500/50 bg-rose-500/15";
  if (level === "ELEVATED") return "text-amber-200 border-amber-500/40 bg-amber-500/10";
  if (level === "MODERATE") return "text-yellow-200 border-yellow-500/40 bg-yellow-500/10";
